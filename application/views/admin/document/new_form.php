			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('admin/documents/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card-body">
						...
						<form action="<?php base_url('admin/document/add') ?>" method="post" enctype="multipart/form-data" >							
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('category') ? 'is-invalid':'' ?>"
								 type="text" name="category" placeholder="Document category" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
								 name="description" placeholder="Document description..."></textarea>
								<div class="invalid-feedback">
